...
<head>
    ...
    <style>
        ...
        h1 {
            color: #0D6EFD; /* Changed text color to match */
            margin-top: 2rem; /* Added margin on top for space */
        }
	...
	<div class="wrapper">
		...
		<div class="main p-3">
            <div class="text-center">
                <h1>{{ $application->destination_name }}</h1> <!-- Changed color and added margin -->
            </div>
            	...
            	<div class="col-sm-12 col-md-8 col-lg-10">
		                            ...
		                            <div class="col-md-6">
			                            <div class="row">
			                            	...
			                            	<div class="col-sm-12 col-md-6">
			                            	    <button type="button" class="btn btn-info w-100" data-bs-toggle="modal" data-bs-target="#companyPermitModal">Company Permit</button>
			                            	    <button type="button" class="btn btn-info w-100 mt-4" data-bs-toggle="modal" data-bs-target="#locationClearanceModal">Location Clearance</button>
			                            	    <button type="button" class="btn btn-info w-100 mt-4" data-bs-toggle="modal" data-bs-target="#barangayClearanceModal">Barangay Clearance</button>
			                            	    <button type="button" class="btn btn-info w-100 mt-4" data-bs-toggle="modal" data-bs-target="#philhealthModal">Philhealth</button>
			                            	</div>

			                            	<div class="col-sm-12 col-md-6">
			                            	    <button type="button" class="btn btn-info w-100" data-bs-toggle="modal" data-bs-target="#corporateBankAccountModal">Corporate Bank Account</button>
			                            	    <button type="button" class="btn btn-info w-100 mt-4" data-bs-toggle="modal" data-bs-target="#secRegistrationModal">SEC Registration</button>
			                            	    <button type="button" class="btn btn-info w-100 mt-4" data-bs-toggle="modal" data-bs-target="#tinModal">TIN</button>
			                            	    <button type="button" class="btn btn-info w-100 mt-4" data-bs-toggle="modal" data-bs-target="#sssModal">SSS</button>
			                            	</div>
			                            </div>
		                            </div>
	                            </div>
            			...
            			<div class="card">
            				<div class="card-body">
            					...
            					<div class="row mt-4">
		                            <div class="col-12">
                                        <form action="/owner/applications/delete/{{ $application->id }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
...
<div class="modal fade" id="companyPermitModal" tabindex="-1" aria-labelledby="companyPermitLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center"> <!-- Centered header text -->
                <h1 class="modal-title fs-5 text-center" id="companyPermitLabel">Company Permit</h1>
            </div>
            <div class="modal-body text-center"> <!-- Centered modal body text -->
